...
public class VOArticuloCompleto implements Serializable{
	...
	public VOArticuloCompleto(int codigo, String nombre, String descripcion,
	...
	public String obtenerFotoEnString()
	{
		byte[] encoded=Base64.encodeBase64(foto);
